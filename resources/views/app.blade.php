...
<body class="theme-red @yield('overflow')">
    <!-- Page Loader -->
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{route('Index')}}">Админ-панель Tarelka</a>
            </div>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                ...
                <div class="info-container">
                    ...
                    <div class="email">admin@tarelka.kz</div>
                    <div class="btn-group user-helper-dropdown">
                        <i class="material-icons" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">keyboard_arrow_down</i>
                        <ul class="dropdown-menu pull-right">
                            <li><a href="{{route('Logout')}}"><i class="material-icons">input</i>Выйти</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2018 <a href="javascript:void(0);">Tarelka</a>.
                </div>
                <div class="version">
                    <b>Version: </b> 1.0.0
                </div>
