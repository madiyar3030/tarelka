    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>Цели</h2>
                <a href="{{route('Goals')}}" class="btn btn-default waves-effect m-t-10">Назад</a>
            </div>
            <!-- Hover Rows -->
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">                    	
	                	<div class="body">
		                    ...
		                    @else
			                    <form action="{{route('SaveGoal')}}" method="post" id="AddGoal" enctype="multipart/form-data">
			                    	{{csrf_field()}}
			                    	<input type="text" name="id" value="{{$goal->id}}" hidden>
			                    	<div class="col-sm-12">
			                        ...
			                        <div class="col-sm-12">
			                        	<img src="{{asset($goal->image)}}" alt="" id="blah" height="150">
			                        </div>
			                        <div class="col-sm-12">
